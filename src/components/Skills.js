            ...
            <div className="row">
                <div className="col-12">
                    <div className="skill-bx wow zoomIn">
                        <h2>Skills</h2>
                        <p>My main focus currently is Frontend and Backend Development, <br></br> however I have a variety of other skills and am always looking to learn new concepts to expand my toolbelt</p>
